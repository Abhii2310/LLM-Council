...
import { ArrowUp, Paperclip, Square, X, StopCircle, Mic, Globe, BrainCog, Folder } from "lucide-react";
...
function useScopedStyle(id, cssText) {
  React.useEffect(() => {
...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 grid w-full max-w-[90vw] md:max-w-[800px] -translate-x-1/2 -translate-y-1/2 gap-4 border border-[#333333] bg-[#1F2023] p-0 shadow-xl rounded-2xl",
        className,
      )}
      {...props}
    >
...
export const PromptInputBox = React.forwardRef(function PromptInputBox(props, ref) {
  useScopedStyle("ai-prompt-box-styles", styles);
